	...
	echo "<table  width='100%'>
		...
		echo "<td align='right'>Halaman :";
			for ($h = 1; $h <= $max; $h++) {
                    ...
                    onClick="$.get('periode.php?hal=<?php echo $list[$h]; ?>', 
	...
	echo "</td>";
		...
		echo "<td align='right'>Halaman :";
			for ($h = 1; $h <= $max; $h++) {
					$list[$h] = $lim * $h - $lim;
					echo " <a href='javascript:void(0)' ";?> 
                    onClick="$.get('periode.php?kode1=<?php echo $_GET['kode1'];?>
