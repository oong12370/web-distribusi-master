...
header("Content-Disposition: attachment; filename=shipment_periode.xls");
?>
...
<table class='table table-hover'>
			...
			$datetime_receive= date("Y-m-d", strtotime($data['datetime_receive']));
